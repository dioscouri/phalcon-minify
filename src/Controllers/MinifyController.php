 ...
 */
    ...
    public function jsAction()
    {
    	$options = array(
			...
			'only_collection' => $this->dispatcher->getParam('only')
		);

    	print_r( \Dsc\Minify\Helper::getListAssets($this->getDI(), 'js', $options));
 ...
 */
    ...
    public function cssAction($collection, $only)
    {
    	echo 'css';
